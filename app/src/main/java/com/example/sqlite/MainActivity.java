...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] CategoriaS = {"Seleccione:", "Motor", "Transmicion", "Sistema electrico", "Electronica", "Chasis"};
    ...
    public void ModificarProducto(View view){
        ...
        if (!IDproducto.isEmpty() && !NombreProducto.isEmpty() && !CategoriaS.equals("Seleccione:") && !cantidad.equals("") && !precio.equals("") && !ubicacion.equals("Seleccione:")){
            ...
            if (Update == 1){
                ...
                Toast.makeText(this, "No se ha podido encontrar el producto a modificar", Toast.LENGTH_LONG).show();
                BaseDatos.close();
            }
        } else {
    ...
    public void AbrirListadoProductos(View view){
        Intent abrir = new Intent(this, ProductosRegistrados.class);
        startActivity(abrir);
    }
}
